package com.example.agendaonline.AgregarNota;
        ...
        Btn_Calendario.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(Agregar_Nota.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker dataPicker, int AnioSeleccionado, int MesSeleccionado, int DiaSeleccionado) {
                        ...
                        if (DiaSeleccionado < 10){
                            ...
                            //Antes 09/11/2022 - ahora 09/11/2022
                        } else {
